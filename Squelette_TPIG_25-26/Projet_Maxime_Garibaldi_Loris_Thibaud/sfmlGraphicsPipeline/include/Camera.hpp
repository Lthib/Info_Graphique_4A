...
#include <KeyframeCollectionFloat.hpp>

class Camera : public KeyframedHierarchicalRenderable
{
public:
    void addFovKeyframe(float fov, float time);
...
private:
    ...
    KeyframeCollectionFloat m_fovKeyframes;//ma collection de keyframe pour modifier ma fov.
};
